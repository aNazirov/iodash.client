...
import { getAll, setTag } from "core/store/tag/tag.thunks";
...
export const TagTbody: React.FC<Props> = ({ path }) => {
  const { tag, tags } = useAppSelector((state) => state.tags);
